...
$(function () {
    ...
    function checkEmailExist(string) {
        ...
        $.ajax({
            type: "POST",
            url: "/sellerLoginFunction/CheckEmailExist",
            async: false,
    ...
    function checkPhoneExist(Phone) {
        ...
        $.ajax({
            type: "POST",
            url: "/sellerLoginFunction/CheckPhoneberExist",
            async: false,
    ...
    $("#regis_GetotpBtn").click(function () {
        ...
        $(this).parent().fadeOut(400, function () {
            $(this).next().fadeIn(400, function () {
                var msg = $(this)
                $.post("/sellerLoginFunction/OTPsend",
    ...
    $("#registerBtn").click(function () {
        ...
        newSeller.Email = regisEmail
        newSeller.Password = regisPass
        newSeller.Name = regisName
        newSeller.PhoneNumber = regisPhone
        newSeller.AddressLine1 = $("#regis_Address1").val()
        newSeller.AddressLine2 = $("#regis_Address2").val()
        newSeller.City = $("#regis_city").val()
        newSeller.ZipCode = $("#regis_zipcode").val()
        newSeller.State = $("#regis_state").val()

  

        $.ajax({
            type: "POST",
            url: "/sellerLoginFunction/Register",
            data: { newSeller },
            success: function (data) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == "Faild") {
                    ...
                    location.href ="/Seller_Manage/Dashboard?sellerid="+data
                }
    ...
    $("#sendOTP").click(function () {
        ...
        $.post("/sellerLoginFunction/ResetPassCheckExist", { AccountId: $("#EmailPhoneInput").val(), type: EorP }, function (data) {
            if (data == "NotExist") {
                ...
                if (EorP == "Email") {
                    $.post("/sellerLoginFunction/SendResetEmailOtp", { sendEmail: $("#EmailPhoneInput").val() }, function (data) {

                        resetOtp = data
                    })
                }
                else {
                    $.get("/sellerLoginFunction/ResetOTPsend", { phoneNumber: $("#EmailPhoneInput").val() }, function (data) {
                ...
                $("#ResetPassword").click(function () {
                    ...
                    if ($("#OtpPass").val() == resetOtp) {
                        ...
                        $.post("/sellerLoginFunction/ResetPassword", { AccountId: $("#EmailPhoneInput").val(), type: EorP }, function () {
